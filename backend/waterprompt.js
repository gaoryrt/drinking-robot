...
async function getWaterPrompt() {
    try {
        ...
        1.只输出段子，不要输出其他无关的话
        2.段子的背景信息是在成都的一家名字叫超有爱科技的公司的百词斩（一款帮助用户背单词的app）部门的前端开发组，主人公名字叫高日天，男的,高日天主要负责前端开发，以及何睿：测试人员，男的。何睿经常会找高日天来解决用户上报的bug，何睿对高日天的称呼一般是叫日天哥
        4.段子一定要搞笑
...
async function getDuanzi() {
    try {
        ...
        同样因为可以重复阅读，段子不像单口喜剧一样铺垫和包袱不能相隔太远（不然听到后面已经忘了前面），在铺垫部分不管有多少货都可以无限往上叠加，最后完成转折后读者自然会回过头去重新看。
        1.只输出段子，不要输出其他无关的话
        2.段子的背景信息是在成都的一家名字叫超有爱科技的公司的百词斩部门的前端开发组，主人公名字叫高日天，男的,高日天主要负责前端开发，其他角色有何睿：测试人员，男的。何睿经常会找高日天来解决用户上报的bug，何睿对高日天的称呼一般是叫日天哥。何睿就坐在高日天的前面的前面
        4.段子一定要搞笑
        5.段子控制在最多70字，尽量保持在60字左右
        6.如果是对话形式的段子，总对话要不超过6句
        7.尽量生成非对话形式的段子
